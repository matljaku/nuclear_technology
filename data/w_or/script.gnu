...
f(x) = a*x + b
g(x) = c*x + d
fit [0:0.5] f(x) "data_2.txt" u 1:2 via a, b
fit [1.5:2] g(x) "data_2.txt" u 1:2 via c, d
...
plot "data_2.txt" using 1:($4 - 273.15) w lp ps 0.2 pt 7 lc 9 title "Axial temperature distribution"
