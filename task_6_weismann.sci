...
mclose(fid);
fid = mopen("./data/temp/it_weis.txt", "w");
for i=1:length(chAv.z)
    print(fid,itemp(i));
end
mclose(fid);
fid = mopen("./data/temp/temp_cout_weis.txt", "w");
for i=1:length(chAv.z)
    print(fid,temp_cout(i));

end
mclose(fid);
fid = mopen("./data/temp/temp_cin_weis.txt", "w");
for i=1:length(chAv.z)
	 print(fid,temp_cin(i));
end
mclose(fid);

fid = mopen("./data/temp/temp_fout_weis.txt", "w");
for i=1:length(chAv.z)
	 print(fid,temp_fout(i));
end
mclose(fid);
fid = mopen("./data/temp/temp_fcen_weis.txt", "w");
for i=1:length(chAv.z)
...
fid = mopen("./data/temp/temp_fuel_weis.txt", "w");
for i=1:length(r_fp)
